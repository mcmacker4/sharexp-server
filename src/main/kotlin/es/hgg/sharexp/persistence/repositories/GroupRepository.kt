...
class GroupRepository {
    ...
    suspend fun createGroup(name: String, owner: UUID): UUID? = withContext(Dispatchers.IO) {
    ...
    suspend fun addGroupMember(groupId: UUID, name: String, userId: UUID? = null): UUID? = withContext(Dispatchers.IO) {
    ...
    suspend fun fetchGroupById(groupId: UUID, principal: UserPrincipal): GroupInfoWithMembers? =
